...
In your DevPayResponseController, you could:
    ...
    def returned
      activation_response       = Devpay.activate!(params[:activation_key], params[:product_code])
      PaidUser.create!({
        ...
...
:product_code and returns a valid DevPay product code.
...
Thanks to david@aws and Amazon:http://www.amazon.com for providing 
